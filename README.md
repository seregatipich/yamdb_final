...
Ваш проект запустился на http://158.160.44.238/

Полная документация [redoc.yaml] доступна по адресу http://158.160.44.238/redoc/
...
```
url = 'http://158.160.44.238/api/v1/titles/{title_id}/reviews/{review_id}/comments/'
